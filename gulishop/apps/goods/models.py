...
class Goods(models.Model):
    ...
    desc = UEditorField(verbose_name='商品详情', width=900, height=400, toolbars='full', imagePath='ueditor/images/', filePath='ueditor/files/', upload_settings={'imageMaxSizing':1024000}, default='')
    ...
    good_num = models.IntegerField(default=100, verbose_name='商品库存数')
    sold_num = models.BooleanField(default=0, verbose_name='商品销数')
...
class Banner(models.Model):
    ...
    index = models.IntegerField(verbose_name='轮播索引')
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
